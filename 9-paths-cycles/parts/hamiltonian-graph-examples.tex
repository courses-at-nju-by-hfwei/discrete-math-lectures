...
\begin{frame}{}
  ...
  \pause
  \begin{center}
    The Petersen graph has \red{\it no} cycles of length \blue{$< 5$}.
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{center}
    ...
    \fig{width = 0.30\textwidth}{figs/C10}
...
\begin{frame}{}
  \begin{columns}
    \column{0.50\textwidth}
      ...
      \end{center}
      \fig{width = 0.60\textwidth}{figs/C10-v0-v4}
    ...
    \column{0.50\textwidth}
      ...
      \end{center}
      \fig{width = 0.60\textwidth}{figs/C10}
