...
\begin{frame}{}
  ...
  \begin{theorem}[K. Wagner (1936); I. F\'{a}ry (1948)]
    Every simple planar graph can be drawn with \red{straight lines}.
  \end{theorem}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \vspace{-0.60cm}
  \[
    \red{\text{cr}}(K_{3, 3}) = 1 \quad (\text{crossing number})
  \]
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \fig{width = 0.40\textwidth}{figs/Petersen-Graph}

  \vspace{-0.60cm}
  \begin{center}
    \teal{\url{https://github.com/courses-at-nju-by-hfwei/discrete-math-lectures/blob/main/11-planarity-coloring/figs/Kuratowski-Petersen.gif}}
  \end{center}
  % \begin{center}
  %   \transduration<0-83>{0}
...
\begin{frame}{}
  ...
  \pause
  \vspace{0.30cm}
  \fig{width = 0.60\textwidth}{figs/euler-formula-tree}
...
\begin{frame}{}
  ...
  \fig{width = 0.30\textwidth}{figs/K5}
...
\begin{frame}{}
  ...
  \fig{width = 0.20\textwidth}{figs/K-3-3-Bipartite}
